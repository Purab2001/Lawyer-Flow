    ...
    return (
        <>
            ...
            <section className="bg-white">
                <div className="container flex items-center min-h-[calc(100vh-85.6px)] px-6 py-12 mx-auto">
                    <div className="flex flex-col items-center max-w-sm mx-auto text-center">
                        ...
                        <div className="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                            ...
                            <button
                                onClick={() => navigate('/')}
                                className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-green-600 rounded-lg shrink-0 sm:w-auto hover:bg-green-700 cursor-pointer"
                            >
                                Take me home
                            </button>
                        </div>
